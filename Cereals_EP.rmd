...
ggplot(cereal_data, aes(x = price_per_serving, y = log(cereal_data$servings_sold))) +
...
ggplot(cereal_data, aes(x = price_per_serving, y = y, color = factor(mkt_quar_id))) +
...
The substitution effect led to a uniform decrease in the market shares of competing products by 1.45% even though they all have varying own price elasticities.
